...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        # add a lambda function to calculate the sigmoid function derivative
        self.activation_function_to_derivative = lambda output: output * (1 - output)
...
#         targets_tranform = np.array(targets, ndmin=2).T
#         print(inputs)
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        hidden_error = error * self.activation_function_to_derivative(final_outputs)
        ...
        delta_weights_h_o += hidden_outputs.T.dot(hidden_error)
    ...
    def run(self, features):
        ...
        '''
        inputs = features # np.array(features, ndmin=2).T
        print(inputs.shape)
        print(inputs)
